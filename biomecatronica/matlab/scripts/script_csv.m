...
%  software Motive:Tracker. A interpretação dos dados È dependente da ordem
...
frRigidBodyCount = zeros(iFrameCount,1);    % utilizar para consistÍncia
frRigidBodyData = zeros(iFrameCount,iRigidBodyCount,11);
frMarkerCount = zeros(iFrameCount,1);       % utilizar para consistÍncia
