...
int atraso
  ...
  for(unsigned int i=0;i<loops;i++){
    ...
    if((cont1==0)&&(passos8>190)&&(passos1<liga_motor_2+para_motor_1_2+1)){
      digitalWrite(pinoPassos1,HIGH);
    }
    ...
    if(cont2){
      ...
      if((passos2<para_motor_2+1)||(passos1>liga_motor_2)){
        digitalWrite(pinoPassos2, LOW);
        passos2++;
        cont2 = vel2;
      }
    ...
    if(cont1){
      ...
      if((passos8>190)&&(passos1<liga_motor_2+para_motor_1_2+1)){
        digitalWrite(pinoPassos1, LOW);
        passos1++;
        cont1 = vel1;
      }
    ...
    if(passos1>liga_motor_2+para_motor_1_2) 
      i=loops_step_2;
