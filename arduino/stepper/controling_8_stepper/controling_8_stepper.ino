...
// referencias
int para_motor_1 = 20; //movimento do motor 1 sozinho
int para_motor_1_2 = 20; //movimento do motor 1 junto do motor 2
...
int atraso
  ...
  for(unsigned int i=0;i<loops;i++){
    ...
    if((cont1==0)&&(passos1<para_motor_1_2+1)){
...
int atraso
  ...
  for(unsigned int i=0;i<loops;i++){
    ...
    if((cont1==0)&&(passos8>110)&&(passos1<para_motor_1+para_motor_1_2+1)){
      digitalWrite(pinoPassos1,HIGH);
    }
    ...
    if(cont1){
      ...
      if((passos8>110)&&(passos1<para_motor_1+para_motor_1_2+1)){
        digitalWrite(pinoPassos1, LOW);
        passos1++;
        cont1 = vel1;
      }
